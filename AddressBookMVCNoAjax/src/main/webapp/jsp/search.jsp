                ...
                <div class="col-md-6">
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label form="search-resident-last-name" class="col-md-4 control-label">Last Name:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="search-resident-last-name" placeholder="Last Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label form="search-street-address" class="col-md-4 control-label">Address:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="search-street-address" placeholder="Address">
                            </div>
                        </div>
                        <div class="form-group">
                            <label form="search-city-name" class="col-md-4 control-label">City:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="search-city-name" placeholder="City">
                            </div>
                        </div>
                        <div class="form-group">
                            <label form="search-state" class="col-md-4 control-label">State:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="search-state" placeholder="State">
                            </div>
                        </div>
                        <div class="form-group">
                            <label form="search-zip-code" class="col-md-4 control-label">Zip Code:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="search-zip-code" placeholder="Zip">
                            </div>
                        </div>
                        <div class="form-group">
